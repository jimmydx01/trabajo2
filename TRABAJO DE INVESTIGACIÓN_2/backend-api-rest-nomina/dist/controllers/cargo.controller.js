...
function getCargos(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const cargos = yield conn.query("SELECT * FROM tb_cargo");
...
function createCargo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const conn = yield conection.getConneccion();
            const cargos = yield conn.query("INSERT INTO tb_cargo SET ?", [modCargo]);
...
function getCargo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const conn = yield conection.getConneccion();
        const cargo = yield conn.query("SELECT * FROM tb_cargo WHERE id = ?", [id]);
...
function deleteCargo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const conn = yield conection.getConneccion();
        yield conn.query("DELETE FROM tb_cargo WHERE id = ?", [id]);
        res.json({
...
function updateCargo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const modCargo = req.body;
        const conn = yield conection.getConneccion();
        yield conn.query("UPDATE tb_cargo set ? WHERE id = ?", [modCargo, id]);
        res.json({
