    ...
    fetch(this.url)
     ...
     .then((cargos) => {
      //  console.log(cargos);
       ...
       //console.log(filas);
       document.getElementById("detalle-cargos").innerHTML = filas; //llenar la tabla
       // eliminar
       ...
       $btnsEdit.forEach((btn) => {
         btn.addEventListener("click",async (e) => {
           ...
           let { descripcionc, estado } = await this.obtenerCargo(this.id);
           document.getElementById("descripcion").value = descripcionc;
