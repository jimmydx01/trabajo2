export class Departamento {
    ...
    constructor() {
      this.id = "";
      this.grabar = true;
      this.url = "http://localhost:3000/departamento";
    }
       ...
       .then((departamentos) => {
         ...
         $btnsEdit.forEach((btn) => {
           btn.addEventListener("click",async (e) => {
             ...
             let { descripciond, estado } = await this.obtenerDepartamento(this.id);
             document.getElementById("descripcion").value = descripciond;
